...
def resnet18(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def resnet34(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def resnet50(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def resnet101(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def resnet152(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def squeezenet1_0(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def squeezenet1_1(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg11(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg11_bn(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg13(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg13_bn(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg16(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg16_bn(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg19(num_classes=1000, pretrained='imagenet', requires_grad=True):
...
def vgg19_bn(num_classes=1000, pretrained='imagenet', requires_grad=True):
